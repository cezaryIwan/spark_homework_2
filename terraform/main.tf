...
terraform {
  backend "azurerm" {
    resource_group_name  = "sparkhm2"
    storage_account_name = "sasparkhm2" # Provide Storage Account name, where Terraform Remote state is stored
    container_name       = "contsparkhm2"
